...
describe('JSON Object',()=>{
    ...
    it('JSON Object',()=>{
        ...
        console.log(simpleObject.key2) //valu2
        console.log(simpleObject["key3"]) //valu3
        ...
        const body={
            "Student":[{"FirstName": "Sena","LastName" : "Cengiz"},
                       {"FirstName": "Yusuf","LastName" : "Aslan"},
                       {"FirstName": "Derya","LastName" : "Soylu"}]}
        
        console.log(body.Student[2].LastName) //Soylu
        console.log(body.Student[1].FirstName) //Yusuf
        console.log(body)// tüm hepsini yazdırır
